...
function renderBenvenuto() {
  contenitore.innerHTML = `
    <div class="schermata-centrata">
      ...
      <p>Prima di iniziare bisogna collegare l'app al tuo progetto Firebase: è un passaggio da fare una volta sola.</p>
...
function renderLogin() {
  contenitore.innerHTML = `
    <div class="schermata-centrata">
      <div class="simbolo">🌱</div>
      <h1>all'Olmo</h1>
      <p>Accedi con l'account condiviso del database delle piante.</p>
      <form id="form-login">
        <div class="campo">
...
function traduciErroreLogin(errore) {
  ...
  return 'Non sono riuscito ad accedere. Riprova tra poco.';
}
